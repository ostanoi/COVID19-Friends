...
Test the hypothesis: does the slope representing the relationship between participants' number of stressors and mean negative affect differ from zero for 1) students with few friends at school (1.5 SD below mean), 2) students with many friends at school (1.5 SD above mean)?<br>
...
Test the hypothesis: does the slope representing the relationship between between participants' number of stressors and mean positive affect differ from zero for 1) students without many friends at school (-1.5 SD), 2) students with many  friends at school (+1.5 SD)?<br>
